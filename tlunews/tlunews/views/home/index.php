        ...
        <div class="row mb-3 date-social-container">
            ...
            <div class="social-icons">
                <ul>
                    ...
                    <li><a type="btn btn-primary" href="<?= DOMAIN.'/views/admin/login.php?action=login'?>">Đăng nhập</a></li>
                </ul>
            </div>
        </div>
                    ...
                    <ul class="list-group">
                        <?php foreach ($categories as $category): ?>
                            <li class="list-group-item">
                                <a href="#" class="text-decoration-none"><?php echo htmlspecialchars($category->getName()); ?></a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
